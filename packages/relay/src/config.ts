...
export const config = {
  ...
  // localhost/127.0.0.1/::1 are always allowed regardless of this list (native app / local
  // dev server flows). All other HTTPS redirect URIs are blocked if this list is empty.
