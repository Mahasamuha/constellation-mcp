...
/** Register an additional sink. Must be called before the broker starts accepting traffic. */
...
/**
 * Register sinks according to configuration. Must be called before the broker
