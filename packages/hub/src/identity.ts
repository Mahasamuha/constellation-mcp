...
export interface ResolvedIdentity {
  ...
  uid: number;
  gid: number;
  /** Home directory from the passwd entry — used to build a clean env for the subnode worker. */
  home: string;
}
 ...
 * apply to the subnode worker at privilege-drop time). Returns null if the
