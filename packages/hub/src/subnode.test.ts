...
import { checkUidRestrictions } from "./subnode.js";
import type { HubConfig, SubnodeUidConfig } from "./config.js";

function configWith(subnode_uid: SubnodeUidConfig): HubConfig {
  return {
